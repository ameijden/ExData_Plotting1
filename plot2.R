...
Allneededdataplot2 <- filter(Allthedata, V1 >= "2007-02-01" & V1 <= "2007-02-02") ## Uses dplyr
...
png(file = "plot2.png")
with(Allneededdataplot2, plot(DT, Global_active_power, type = "S", xlab="", ylab="Global Active Power (kilowatts)"))
dev.off()
